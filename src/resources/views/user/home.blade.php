    ...
    <div class="min-h-screen bg-gray-50 py-10">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between mb-10 gap-4">
                ...
                <a href="/creteQestion"
                    class="flex items-center justify-center px-6 py-3 bg-indigo-600 text-white font-bold rounded-xl shadow-lg shadow-indigo-200 hover:bg-indigo-700 hover:-translate-y-1 transition-all duration-200">
            ...
            <div class="flex flex-col lg:flex-row gap-8">
                <div class="lg:w-2/3 space-y-6">
                    @foreach ($questions as $item)
                        <div
                            class="group relative bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-xl hover:border-indigo-100 transition-all duration-300">
                            <div class="flex items-start justify-between">
                                <div class="flex-1">
                                    <span
                                        class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-indigo-50 text-indigo-700 mb-3">
                                        # {{ $item->location ?? 'General' }}
                                    </span>

                                    <h2
                                        class="text-xl font-bold text-gray-900 group-hover:text-indigo-600 transition-colors">
                                        <a href="/qestion/{{$item->id}}">{{ $item->title }}</a>
                                    </h2>
                            ...
                            <div class="mt-6 pt-6 border-t border-gray-50 flex items-center justify-between">
                                <div class="flex items-center space-x-3">
                                    <div
                                        class="h-8 w-8 rounded-full bg-indigo-600 flex items-center justify-center text-white font-bold text-xs uppercase">
                ...
                <div class="lg:w-1/3">
                    <div class="bg-indigo-900 rounded-3xl p-8 text-white shadow-2xl shadow-indigo-200">
                        ...
                        <div class="space-y-6">
                            ...
                            <a href="#"
                                class="block w-full text-center py-3 bg-white text-indigo-900 font-bold rounded-xl hover:bg-indigo-50 transition-colors">
                                View Profile
                            </a>
                        </div>

                        <div class="mt-8 pt-8 border-t border-white/10 text-center">
                            <p class="text-indigo-200 text-sm">Looking for help? Check out our <a href="#"
                                    class="underline text-white">Documentation</a></p>
                        </div>
                    </div>
                </div>
            </div>
